...
#define FILTER_FRIENDLY_NAME        L"ntfwkm NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{528ed75f-b63d-4a97-aba7-0a85a6707ce5}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"ntfwkm"
...
DRIVER_DISPATCH ntfwkmDispatch;

DRIVER_DISPATCH ntfwkmDeviceIoControl;
